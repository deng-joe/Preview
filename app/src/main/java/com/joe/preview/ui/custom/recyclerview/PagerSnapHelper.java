...
public class PagerSnapHelper extends LinearSnapHelper {
    ...
    private RecyclerSnapItemListener snapItemListener;
    private OrientationHelper verticalHelper, horizontalHelper;

    public PagerSnapHelper(RecyclerSnapItemListener snapItemListener) {
        this.snapItemListener = snapItemListener;
    }
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        ...
        if (targetPosition >= 0)
            snapItemListener.onItemSnap(targetPosition);
